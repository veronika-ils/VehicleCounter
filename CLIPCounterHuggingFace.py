...
HF_MODEL_ID = "openai/clip-vit-large-patch14-336"#drug model
...
def _get_txt_feats_cached(max_k: int) -> torch.Tensor:
    ...
    return _TXT_FEATS_CACHE[key]#isti se za site sliki pa izbegnuva pvotorno presmetuvanje
